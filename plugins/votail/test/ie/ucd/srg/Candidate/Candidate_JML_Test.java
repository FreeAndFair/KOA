     ...
     extends Candidate_JML_TestData
{
    ...
    */
        ...
        try {
            ...
            while (!receivers$iter.atEnd()) {
                ...
                while (!vint$1$iter.atEnd()) {
                    final ie.koa.Candidate receiver$
                        = (ie.koa.Candidate) receivers$iter.get();
                    final int count
                        = vint$1$iter.getInt();
                    methodTests$.addTest
    ...
    protected static class TestGetVoteAtCount extends OneTest {
        /** The receiver */
        private ie.koa.Candidate receiver$;
        /** Argument count */
        private int count;

        /** Initialize this instance. */
        public TestGetVoteAtCount(ie.koa.Candidate receiver$, int count) {
    ...
    protected static class TestGetTotalVote extends OneTest {
        ...
        /** Initialize this instance. */
        public TestGetTotalVote(ie.koa.Candidate receiver$) {
            super("getTotalVote");
            this.receiver$ = receiver$;
        }
    ...
    protected static class TestGetOriginalVote extends OneTest {
        ...
        /** Initialize this instance. */
        public TestGetOriginalVote(ie.koa.Candidate receiver$) {
    ...
    protected static class TestGetState extends OneTest {
        ...
        /** Initialize this instance. */
        public TestGetState(ie.koa.Candidate receiver$) {
            super("getState");
            this.receiver$ = receiver$;
        }
    ...
    protected static class TestGetCandidateID extends OneTest {
        ...
        /** Initialize this instance. */
        public TestGetCandidateID(ie.koa.Candidate receiver$) {
    ...
    protected static class TestAddVote extends OneTest {
        ...
        /** Initialize this instance. */
        public TestAddVote(ie.koa.Candidate receiver$, int numberOfVotes, int count) {
    ...
    protected static class TestRemoveVote extends OneTest {
        ...
        /** Initialize this instance. */
        public TestRemoveVote(ie.koa.Candidate receiver$, int numberOfVotes, int count) {
    ...
    protected static class TestSetCandidateID extends OneTest {
        ...
        /** Initialize this instance. */
        public TestSetCandidateID(ie.koa.Candidate receiver$, long candidateIDToAssign) {
    ...
    protected static class TestDeclareElected extends OneTest {
        ...
        /** Initialize this instance. */
        public TestDeclareElected(ie.koa.Candidate receiver$) {
    ...
    protected static class TestDeclareEliminated extends OneTest {
        ...
        /** Initialize this instance. */
        public TestDeclareEliminated(ie.koa.Candidate receiver$) {
    ...
    protected static class TestGetNumberOfVotesInLastSet extends OneTest {
        ...
        /** Initialize this instance. */
        public TestGetNumberOfVotesInLastSet(ie.koa.Candidate receiver$) {
    ...
    protected static class TestGetLastSetAddedCountNumber extends OneTest {
        ...
        /** Initialize this instance. */
        public TestGetLastSetAddedCountNumber(ie.koa.Candidate receiver$) {
        ...
        try {
            ...
            while (!receivers$iter.atEnd()) {
                ...
                while (!vie_koa_Candidate$1$iter.atEnd()) {
                    final ie.koa.Candidate receiver$
                        = (ie.koa.Candidate) receivers$iter.get();
                    final ie.koa.Candidate other
                        = (ie.koa.Candidate) vie_koa_Candidate$1$iter.get();
                    methodTests$.addTest
    ...
    protected static class TestIsAfter extends OneTest {
        ...
        private ie.koa.Candidate receiver$;
        /** Argument other */
        private ie.koa.Candidate other;

        /** Initialize this instance. */
        public TestIsAfter(ie.koa.Candidate receiver$, ie.koa.Candidate other) {
            super("isAfter"+ ":" + (other==null? "null" :"{ie.koa.Candidate}"));
            this.receiver$ = receiver$;
            this.other = other;
        }
