...
public class ElectionAlgorithm {
   ...
   //@ protected model long numberEliminated;
   ...
   //@ protected invariant numberEliminated <= totalCandidates - seats;
	/*@ protected invariant (state == COUNTING || state == FINISHED || 
	  ...
	  @*/
	/** Number of candidates excluded from election so far */
	protected long numberOfCandidatesEliminated;
  ...
  //@ protected represents totalSeats <- totalNumberOfSeats;
   ...
   /** Total number of valid ballot papers */
	protected long totalNumberOfVotes;
   ...
   //@ protected represents totalVotes <- totalNumberOfVotes;
	...
	// @design- totalNumberOfVotes was changed to long to comply to above bug
   ...
   //@ public invariant nonTransferableVotes <= totalVotes;
	...
	/** Number of votes so far which did not have a transfer to
	 * a continuing candidate */
	protected long totalofNonTransferableVotes;
   ...
   //@ public invariant depositSavingThreshold <= totalVotes;
	...
	protected long savingThreshold;
   ...
   //@ protected invariant numberOfSurpluses <= numberElected;
	/** Number of candidates with surplus votes */
	protected long totalNumberOfSurpluses;
   ...
   //@ public invariant sumOfSurpluses <= totalVotes;
	/*@ invariant (state == COUNTING) 
	  ...
	  @*/
	/** Number of candidates with surplus votes */
	protected long totalSumOfSurpluses;
   ...
   //@ public invariant remainingSeats <= seats;
	...
	protected long totalRemainingSeats;
   ...
   //@ public invariant 0 <= numberOfContinuingCandidates;
	/*@ public invariant 
	  ...
	  @*/
	/** Number of candidates neither elected nor excluded from election */
	protected long totalNumberOfContinuingCandidates;
   ...
   //@ public invariant highestSurplus <= sumOfSurpluses;
	/*@ invariant (state == COUNTING) ==> highestSurplus ==
	  ...
	  @*/
	/** The highest number of votes held by a continuing candidate */
	protected long highestAvailableSurplus;
   ...
   //@ public invariant sumOfOtherContinuingVotes <= totalVotes;
	/*@ invariant (state == COUNTING) ==> sumOfOtherContinuingVotes ==
	  ...
	  @*/
	/** The highest number of votes held by a continuing candidate */
	protected long totalSumOfOtherContinuingVotes;
   ...
   //@ public invariant 0 <= numberOfEqualHighestContinuing;
	/*@ public invariant
	  ...
	  @*/
	/** Number of candidates with equal highest continuing votes */
	protected long totalNumberOfEqualHighestContinuing;
   ...
   //@ public invariant 0 <= numberOfEqualLowestContinuing;
	/*@ public invariant
	  ...
	  @*/
	/**  Number of candidates with equal lowest non-zero votes */
	protected long totalNumberOfEqualLowestContinuing;
...
/*@ also
  ...
  @*/
protected void eliminateCandidates(Candidate[] candidatesToEliminate, long numberToEliminate){
	// @assert false;
}
...
/*@ also
  ...
  @*/
	protected /*@ pure @*/ int getPotentialTransfers(Candidate fromCandidate,long toCandidateID) {
		int num = 0;
...
/*@ also 
  ...
  @*/
	protected /*@ pure @*/ long getNextContinuingPreference(Ballot ballot) {
		if (status == COUNTING) {
...
/*@ also
  ...
  @   toCandidate.getCandidateID()));
  @*/
	protected /*@ pure @*/ long getActualTransfers(Candidate fromCandidate, Candidate toCandidate) {
...
/*@ also 
  ...
  @   ==> \result == 0;
  @*/
protected /*@ pure @*/ long getRoundedFractionalValue(/*@ non_null @*/ Candidate fromCandidate, /*@ non_null @*/ Candidate toCandidate){
...
/*@ also 
  ...
  @*/
protected /*@ pure @*/ long getTransferShortfall(/*@ non_null @*/ Candidate fromCandidate){
	long temp =0;
...
/*@ also 
  ...
  @*/
protected /*@ pure @*/ long randomSelection(/*@ non_null @*/ Candidate firstCandidate, /*@ non_null @*/ Candidate secondCandidate){
...
/*@ also
  ...
  @   getSurplus(fromCandidate));
  @*/
protected /*@ pure @*/ long getTransferRemainder(/*@ non_null @*/ Candidate fromCandidate, /*@ non_null @*/ Candidate toCandidate){
	long temp = 0;
...
/*@ also
  ...
  @*/
protected /*@ pure @*/ long getCandidateOrderByHighestRemainder(Candidate fromCandidate, Candidate toCandidate){
	long num = 0;
...
/*@ also
  ...
  @*/
protected /*@ pure @*/ long getTotalTransferableVotes(/*@ non_null @*/ Candidate fromCandidate){
...
/*@ also
  ...
  @*/
protected /*@ pure @*/ void transferVotes(/*@ non_null @*/ Candidate fromCandidate, /*@ non_null @*/ Candidate toCandidate, long numberOfVotes){
 	 //@ assert false;
}
