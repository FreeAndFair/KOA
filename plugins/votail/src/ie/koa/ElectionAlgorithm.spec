...
public class ElectionAlgorithm {
   ...
   *   primitive type <code>long</code> has a maximum value of over two billion
  ...
  /*@ requires state == COUNTING;
    ...
    @   );
    @*/
  protected /*@ pure @*/ long getNextContinuingPreference(/*@ non_null @*/ Ballot ballot);
  ...
  /*@ requires (state == COUNTING);
    ...
    @     toCandidate.getCandidateID()));
    @*/
  protected /*@ pure @*/ long getActualTransfers (
		  /*@ non_null @*/ Candidate fromCandidate, 
  ...
  /*@ requires state == COUNTING;
    ...
    @   ==> \result == 0;
    @*/
  protected /*@ pure @*/ long getRoundedFractionalValue (
		  /*@ non_null @*/ Candidate fromCandidate, 
		  /*@ non_null @*/ Candidate toCandidate);
  ...
  /*@ requires state == COUNTING;
    ...
    @*/
  protected /*@ pure @*/ long randomSelection (
		  /*@ non_null @*/ Candidate firstCandidate,
		  /*@ non_null @*/ Candidate secondCandidate);
  ...
  /*@
    ...
    @*/
  protected /*@ pure @*/ long getOrder(/*@ non_null @*/ Candidate candidate);
