  ...
  implements Comparable, java.io.Serializable
{
  ...
  //@ invariant (\forall int i; 0 <= i && i < MY_CACHED_KIESKRINGEN.length; MY_CACHED_KIESKRINGEN[i] == null || MY_CACHED_KIESKRINGEN[i].number() == i);
   ...
   *   modifies a_kieskring_name.owner;
