...
public class AuditLog 
{
 ...
 //@ constraint \old(importCandidatesSuccess) ==> importCandidatesSuccess;
 ...
 //@ constraint \old(importVotesSuccess) ==> importVotesSuccess;
 //FF - Added the above constraint
 ...
 //@ constraint \old(importPrivKeySuccess) ==> importPrivKeySuccess;
 //FF - Added the above constraint
 ...
 //@ constraint \old(importPubKeySuccess) ==> importPubKeySuccess;
 //FF - Added the above constraint
 ...
 //@ constraint \old(keypairSuccess) ==> keypairSuccess;
 //FF - Added the above constraint
 ...
 //@ constraint \old(decryptSuccess) ==> decryptSuccess;
 ...
 //@ constraint \old(countSuccess) ==> countSuccess;
 //FF - Added the above constraint
