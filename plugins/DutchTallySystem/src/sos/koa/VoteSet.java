  ...
  implements java.io.Serializable
{
  ...
  final /*@ pure @*/ boolean
    validateRedundantInfo(final /*@ non_null @*/ String a_candidate_code,
                          ...
                          throws KOAException, IllegalArgumentException {
  ...
  final /*@ pure @*/ boolean
    validateKiesKringNumber(final /*@ non_null @*/ String a_candidate_code,
                            final /*@ non_null @*/ String a_kieskring_number) throws IllegalArgumentException {
    if (!(my_vote_has_been_initialized && !my_vote_has_been_finalized)) {
      throw new IllegalArgumentException();
    }
   ...
   * </jml></pre>
   */
  final void initializeVote()  throws IllegalArgumentException {
    if (my_vote_has_been_initialized || my_vote_has_been_finalized) {
      throw new IllegalArgumentException();
    }
   ...
   * </jml></pre>
   */
  final void addVote(final /*@ non_null @*/ String a_candidate_code) throws IllegalArgumentException {
   ...
   * </jml></pre>
   */
  final void finalizeVote()  throws IllegalArgumentException {
    if (!(my_vote_has_been_initialized && !my_vote_has_been_finalized)) {
      throw new IllegalArgumentException();
    }
   ...
   * </jml></pre>
   */
  final /*@ pure @*/ int voteCount(final int a_candidate_code) throws IllegalArgumentException {
    if (!(my_vote_has_been_initialized && my_vote_has_been_finalized)) {
      throw new IllegalArgumentException();
    }
    final Candidate candidate = my_candidate_list.getCandidate(a_candidate_code);
