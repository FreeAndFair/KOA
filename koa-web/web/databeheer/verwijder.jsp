        ...
        <table width="725" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr valign="top">
                ...
                <td width="94%" valign="top" height="360">
					<FORM action="UploadKRRemove" method="POST" enctype="multipart/form-data">
				    ...
				    <TBODY>
    				    ...
    				    <TR>
            				<TD>Location of voters remove resistant</TD>
        				...
        				<TR>
                          <TD align="right">
            		        <input type="submit" name="verwerk_lijst" value="Verwerk lijst" width="108" height="46" border="0" alt="druk op verder om het verwijder bestand te valideren">
            		      </TD>
        				</TR>
			...
			<TR>
                    <td align="left">
                    <BUTTON STYLE="width:200" ONCLICK="window.location='index.jsp'">Return to Homepage</BUTTON>
                   </td>
			</TR>
			<tr valign="top">
