...
<TITLE>KOA Remote Voting - Voorzitter - Hoofdpagina</TITLE>
  ...
  <tr valign="top">
    ...
    <td width="94%" valign="top" height="360">
      <table width="100%" height="100%">
	    <tr valign="top">
	      <td>
	        A problem has arisen during the export of the application:
						<br><H3><%= request.getAttribute("ERROR") %></H3>
          </td>
        </tr>
        <tr>
          <td align="right">&nbsp;
        ...
        <tr>
          <td align="left"><BUTTON STYLE="width:200" ONCLICK="window.location='Index'">Terug naar statusoverzicht</BUTTON>
          </td>
        </tr>
      </table>
    </td>
