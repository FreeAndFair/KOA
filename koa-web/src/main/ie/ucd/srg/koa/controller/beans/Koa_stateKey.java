...
public class Koa_stateKey implements java.io.Serializable
{
	...
	{
		if (otherKey
			instanceof ie.ucd.srg.koa.controller.beans.Koa_stateKey)
		{
			ie.ucd.srg.koa.controller.beans.Koa_stateKey o =
				(ie.ucd.srg.koa.controller.beans.Koa_stateKey) otherKey;
