...
public class EsbfingerprintsKey implements java.io.Serializable
{
	...
	{
		if (otherKey instanceof ie.ucd.srg.koa.esb.beans.EsbfingerprintsKey)
		{
			ie.ucd.srg.koa.esb.beans.EsbfingerprintsKey o =
				(ie.ucd.srg.koa.esb.beans.EsbfingerprintsKey) otherKey;
