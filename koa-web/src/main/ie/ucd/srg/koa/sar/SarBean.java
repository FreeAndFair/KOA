...
public class SarBean implements javax.ejb.EntityBean
{
	...
	//	 */
	//	public ie.ucd.srg.koa.sar.SarKey ejbCreate(java.lang.String kiezeridentificatie) throws javax.ejb.CreateException {
	//		_initLinks();
	 ...
	 * ejbCreate method for a CMP entity bean.
	 */
	public ie.ucd.srg.koa.sar.SarKey ejbCreate(
