...
public class KRFingerprintsKey implements java.io.Serializable
{
	...
	{
		if (otherKey instanceof ie.ucd.srg.koa.kr.beans.KRFingerprintsKey)
		{
			ie.ucd.srg.koa.kr.beans.KRFingerprintsKey o =
				(ie.ucd.srg.koa.kr.beans.KRFingerprintsKey) otherKey;
