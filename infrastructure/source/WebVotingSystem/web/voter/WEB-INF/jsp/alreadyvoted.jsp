...
<%@page import="ie.ucd.srg.koa.dataobjects.*"%>
<%@page import="ie.ucd.srg.koa.votecommands.*"%>
<%@page import="ie.ucd.srg.logica.eplatform.command.http.*"%>
...
<% 
   ...
   if(xObject != null)
   {
   	  ...
   	  if(xObject instanceof ie.ucd.srg.koa.votecommands.AlreadyVotedCommand)
   	  {
