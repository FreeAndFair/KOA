...
<%@page import="ie.ucd.srg.logica.eplatform.ticket.TicketConstants"%>
<%@page import="ie.ucd.srg.koa.votecommands.*"%>
            ...
            <tr valign="top">
                ...
                <table width="100%" border="0" cellpadding="3" height="267">
                  <tr>
                    ...
                    <td width="100%" height="230" valign="top"><p><font size="2">Enter your vote code and access code. The access code you yourself have given up on the recording form, the vote code has at the same time transmitted you with the overview of lists of candidates. 
                        </font></p>
                        <table width="100%" border="0" cellpadding="5">
                            <tr>
                                
                          <td width="27%"><font size="2">Vote code:</font></td>
                                <td width="73%"><input type="text" name="USER" maxlength="9"></td>
                            </tr>
                            <tr>
                                
                          <td><font size="2">Access code:</font></td>
