...
<TITLE>Kiezen op afstand - Data Management Functionality</TITLE>
                ...
                <td width="3%" align="left" height="380"><img src="images/blueline_3.gif" width="1" height="380"></td>
                 ...
                 <br>                   
                   <table width="100%" height="100%">
                 	 <tr valign="top">
                 	   <td>
                 	     The file has been offered for processing to the system. On the scheduler overview the progress is see. Click <a href="ScheduledJobsOverview">here</a> to show overview to the scheduler.
                 	   </td>
                 	 </tr>
                 	 <tr>
                 	   <td align="right">
