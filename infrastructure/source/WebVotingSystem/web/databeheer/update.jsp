        ...
        <table width="725" border="0" align="center" cellpadding="0" cellspacing="0" valign="middle">
            ...
            <tr valign="top">
                ...
                <td width="94%" valign="top" height="360">
					<FORM action="UploadKRUpdate" method="POST" enctype="multipart/form-data">
					<TABLE border="0" align="center" cellpadding="0" cellspacing="0" valign="middle" height="100%" width="100%">
				    <TBODY>
				        <TR>
				            <TD><BR></TD>
				            <TD><BR></TD>
        				...
        				<TR>
                          ...
                          <TD align="right">
                            <input type="submit" name="verwerk_lijst" value="Process List" width="108" height="46" border="0" alt="druk op verder om het aanvullende kiezersbestand te valideren">
                          </TD>
        				</TR>
    				</TBODY>
					</TABLE>
