...
<%@page import="ie.ucd.srg.koa.databeheer.command.*,ie.ucd.srg.koa.databeheer.dataobjects.*,java.util.*,java.text.*,ie.ucd.srg.koa.constants.FunctionalProps" %>
...
<table width="725" border="0" align="center" cellpadding="0" cellspacing="5">
  <tr>
     <td align="left"><BUTTON STYLE="width:200" ONCLICK="window.location='index.jsp'">Return to Homepage</BUTTON>
    </td>
  </tr>
</table>
<table width="725" border="0" align="center" cellpadding="0" cellspacing="0">
