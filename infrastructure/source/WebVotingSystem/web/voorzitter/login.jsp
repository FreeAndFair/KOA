        ...
        <table width="725" border="0" align="center" cellpadding="0" cellspacing="0" valign="middle">
            ...
            <tr valign="top">
                ...
                <table width="100%" height="100%">
                	<tr><td colspan="3">KOA Login Page</td></tr>
                	<tr>
                	   <td width="10%">&nbsp;</td>
					...
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
                		<TD align="right"><input type="image" src="images/verder_3.gif" width="108" height="46" border="0" alt="druk op verder om het aanvullende bestand te valideren"></TD>
                	</tr>
                	</table>
				</FORM>
				</td>
