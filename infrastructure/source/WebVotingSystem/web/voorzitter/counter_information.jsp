...
<%@page import="ie.ucd.srg.koa.voorzitter.command.*,java.util.*,ie.ucd.srg.koa.dataobjects.CounterData, ie.ucd.srg.koa.constants.*" %>

<HEAD>
<META name="GENERATOR" content="IBM WebSphere Studio">
<META http-equiv="Pragma" content="no-cache"/>
<META http-equiv="Expires" content="-1"/>
<TITLE>KOA Remote Voting - Voorzitter - Tellerstanden</TITLE>
