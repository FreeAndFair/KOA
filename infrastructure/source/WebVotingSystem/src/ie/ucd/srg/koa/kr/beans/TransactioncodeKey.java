...
public class TransactioncodeKey implements java.io.Serializable
{
	...
	{
		if (otherKey instanceof ie.ucd.srg.koa.kr.beans.TransactioncodeKey)
		{
			ie.ucd.srg.koa.kr.beans.TransactioncodeKey o =
				(ie.ucd.srg.koa.kr.beans.TransactioncodeKey) otherKey;
