...
import ie.ucd.srg.koa.soap.response.AreYouThereResponse;
import ie.ucd.srg.koa.soap.response.SubscribeResponse;
import ie.ucd.srg.koa.soap.response.UnsubscribeResponse;
import ie.ucd.srg.koa.soap.response.VerifyCandidateResponse;
import ie.ucd.srg.koa.soap.response.VerifyVoterResponse;
import ie.ucd.srg.koa.soap.response.VoteResponse;
import ie.ucd.srg.koa.soap.response.VotingDetails;
import ie.ucd.srg.koa.ticket.KOATicketFactory;
import ie.ucd.srg.koa.ticket.KOATicketResponse;
import ie.ucd.srg.koa.utils.KOALogHelper;
import ie.ucd.srg.koa.utils.ObjectCache;
import ie.ucd.srg.koa.votecommands.VerifyCandidateCommand;
import ie.ucd.srg.koa.votecommands.VoteCommand;
...
public class VSL
{
				...
				if (xStemTransactie != null)
				{
					...
					else
					{
								...
								== StemTransactie.KIEZER_DELETED)
						{
							...
							xStemTransactie.VoteStatus
								== StemTransactie.INVALID_CANDIDATE)
						{
	...
	private EJBCommandTarget getCommandTarget()
	{
		...
		SystemProperties props =
			ie.ucd.srg.logica.eplatform.util.SystemProperties.getSystemProperties();
	...
	private KOATicketResponse getTicketResponse(
		...
		throws KOAException
	{
		ie.ucd.srg.logica.eplatform.ticket.TicketRequest xRequest =
			new ie.ucd.srg.logica.eplatform.ticket.TicketRequest();
		...
		catch (ie.ucd.srg.logica.eplatform.error.EPlatformException epe)
		{
			KOALogHelper.logError(
				"VSL.getTicket",
