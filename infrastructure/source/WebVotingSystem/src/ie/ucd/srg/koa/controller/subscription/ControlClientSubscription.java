/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.controller.subscription.ControlClientSubscription.java
  *
  * -----------------------------------------------------------------------
  * 
  ...
  * -----------------------------------------------------------------------
  */
package ie.ucd.srg.koa.controller.subscription;
...
import ie.ucd.srg.koa.controller.subscription.AbstractClientSubscription;
