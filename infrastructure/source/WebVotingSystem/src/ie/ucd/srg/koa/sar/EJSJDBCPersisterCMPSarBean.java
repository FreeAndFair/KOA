 ...
 * @generated
 */
public class EJSJDBCPersisterCMPSarBean extends EJSJDBCPersister implements ie.ucd.srg.koa.sar.EJSFinderSarBean {
	/**
	 * @generated
	 */
	...
	public void hydrate(EntityBean eb, Object data, Object pKey) throws Exception {
		Object objectTemp = null;
		SarBean b = (SarBean) eb;
		ie.ucd.srg.koa.sar.SarKey _primaryKey = (ie.ucd.srg.koa.sar.SarKey)pKey;
	...
	public void refresh(EntityBean eb, boolean forUpdate) throws Exception {
		SarBean b = (SarBean) eb;
		ie.ucd.srg.koa.sar.SarKey _primaryKey = new ie.ucd.srg.koa.sar.SarKey();
	...
	public Object getPrimaryKey(Object data) throws Exception {
		ie.ucd.srg.koa.sar.SarKey key = new ie.ucd.srg.koa.sar.SarKey();
		java.sql.ResultSet resultSet = (java.sql.ResultSet) data;
	 ...
	 * @generated
	 */
	public ie.ucd.srg.koa.sar.Sar findByPrimaryKey(ie.ucd.srg.koa.sar.SarKey primaryKey) throws java.rmi.RemoteException, javax.ejb.FinderException {
		return (ie.ucd.srg.koa.sar.Sar) home.activateBean(primaryKey);
	}
	/**
	 * findByStemcode
	 * @generated
	...
	public ie.ucd.srg.koa.sar.Sar findByStemcode(java.lang.String sStemcode) throws javax.ejb.FinderException, java.rmi.RemoteException {
		...
		ie.ucd.srg.koa.sar.Sar result = null;
		...
		try {
			...
			if (tmpFinder.hasMoreElements()) {
				result = (ie.ucd.srg.koa.sar.Sar)tmpFinder.nextElement();
			}
		}
		catch (Exception ex) {
