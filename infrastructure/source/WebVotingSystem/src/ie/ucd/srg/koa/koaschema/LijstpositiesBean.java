...
import ie.ucd.srg.koa.koaschema.LijstpositiesToFk_klkr_1Link;
import ie.ucd.srg.koa.koaschema.LijstpositiesToKandidaatcodesLink;
...
public class LijstpositiesBean implements javax.ejb.EntityBean
{
	...
	private transient ie.ucd.srg.ivj.ejb.associations.interfaces.ManyLink kandidaatcodesLink;
	/**
	...
	private transient ie.ucd.srg.ivj.ejb.associations.interfaces.SingleLink fk_klkr_1Link;
	/**
	 ...
	 */
	public ie.ucd.srg.koa.koaschema.LijstpositiesKey ejbCreate(
	...
	public void secondaryAddKandidaatcodes(
		ie.ucd.srg.koa.koaschema.Kandidaatcodes aKandidaatcodes)
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	protected ie.ucd.srg.ivj.ejb.associations.interfaces.ManyLink getKandidaatcodesLink()	{
	...
	public void setFk_klkr_1(
		ie.ucd.srg.koa.koaschema.Kieslijsten aFk_klkr_1)
		throws java.rmi.RemoteException
	{
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	protected ie.ucd.srg.ivj.ejb.associations.interfaces.SingleLink getFk_klkr_1Link()	{
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	public ie.ucd.srg.koa.koaschema.KieslijstenKey getFk_klkr_1Key()
	{
		ie.ucd.srg.koa.koaschema.KieslijstenKey temp =
			new ie.ucd.srg.koa.koaschema.KieslijstenKey();
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	public ie.ucd.srg.koa.koaschema.Kieslijsten getFk_klkr_1()
		throws java.rmi.RemoteException, javax.ejb.FinderException
	{
		return (ie.ucd.srg.koa.koaschema.Kieslijsten) this
			.getFk_klkr_1Link()
			.value();
	}
	/**
