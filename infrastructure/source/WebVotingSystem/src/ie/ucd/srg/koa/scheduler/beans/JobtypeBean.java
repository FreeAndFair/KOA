...
public class JobtypeBean implements javax.ejb.EntityBean
{
	...
	private transient ie.ucd.srg.ivj.ejb.associations.interfaces.ManyLink scheduledjobLink;
	/**
	 * getEntityContext
	 */
	 ...
	 */
	public ie.ucd.srg.koa.scheduler.beans.JobtypeKey ejbCreate(
	...
	public void secondaryAddScheduledjob(
		ie.ucd.srg.koa.scheduler.beans.Scheduledjob aScheduledjob)
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	protected ie.ucd.srg.ivj.ejb.associations.interfaces.ManyLink getScheduledjobLink()	{
