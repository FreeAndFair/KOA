/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.databeheer.command.SelectExportCommand.java
  *
  * -----------------------------------------------------------------------
  * 
...
import ie.ucd.srg.koa.databeheer.dataobjects.ExportItem;
import ie.ucd.srg.koa.db.DBUtils;
import ie.ucd.srg.koa.esb.beans.ESBSessionEJBBean;
