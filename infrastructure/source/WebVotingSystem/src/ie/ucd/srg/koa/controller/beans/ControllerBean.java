/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.controller.beans.ControllerBean.java
  *
  * -----------------------------------------------------------------------
  * 
...
import ie.ucd.srg.koa.controller.SubscriptionManager;
import ie.ucd.srg.koa.controller.beans.Koa_state;
import ie.ucd.srg.koa.controller.beans.Koa_stateHome;
import ie.ucd.srg.koa.controller.subscription.ClientSubscription;
import ie.ucd.srg.koa.dataobjects.CallResult;
import ie.ucd.srg.koa.dataobjects.CounterData;
import ie.ucd.srg.koa.db.ControllerDB;
import ie.ucd.srg.koa.esb.beans.ESBSessionEJB;
...
import ie.ucd.srg.koa.security.KOAPublicKey;
...
{
	private /*@ non_null @*/ javax.ejb.SessionContext mySessionCtx;
	/**
	 * getSessionContext
	 */
	//@ ensures \result != null;
	public /*@ pure @*/ javax.ejb.SessionContext getSessionContext()
	{
		return mySessionCtx;
	}
	/**
	 ...
	 */
	//@ requires sInitiationAction != null;
	...
	private void privateCollectCounters(String sInitiationAction, int timing)
	{
		...
		Enumeration subscribers = vSubscribers.elements();
		...
		{
			xSubscription = (ClientSubscription) subscribers.nextElement();
			try
			{
				/* collect the counter */
	 ...
	 */
	//@ requires sPinCode1 != null;
	//@ requires sPinCode2 != null;
	//@ ensures \result != null;
	//@ signals (Exception) false;
	 ...
	 * 
	 */
	//@ requires baPrivateKey != null;
	//@ requires sPassword != null;
	//@ ensures \result != null;
	//@ signals (Exception) false;
	...
	private boolean isValidStateChange(String sNewState) throws KOAException
	{
		...
		Enumeration elements = vValidNew.elements();
		/* loop through all the states */
		String sValidState = null;
		while (elements.hasMoreElements())
		{
			/* get the next valid state */
			sValidState = (String) elements.nextElement();
	 ...
	 * 
	 */
	// requires iType - what are the sensible values for this
