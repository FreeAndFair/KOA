...
public class DistrictenBean implements javax.ejb.EntityBean {
	...
	private transient ie.ucd.srg.ivj.ejb.associations.interfaces.SingleLink fk_dist_kkrLink;
	/**
	 * getEntityContext
	 */
	 ...
	 */
	public ie.ucd.srg.koa.koaschema.DistrictenKey ejbCreate(java.lang.String districtnummer) throws javax.ejb.CreateException {
		_initLinks();
	...
	protected void _removeLinks() throws java.rmi.RemoteException, javax.ejb.RemoveException {
		...
		for (int i = 0; i < links.size() ; i++) {
			try {
				((ie.ucd.srg.ivj.ejb.associations.interfaces.Link) links.get(i)).remove();
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	protected ie.ucd.srg.ivj.ejb.associations.interfaces.SingleLink getFk_dist_kkrLink() {
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	public ie.ucd.srg.koa.koaschema.KieskringenKey getFk_dist_kkrKey() {
		ie.ucd.srg.koa.koaschema.KieskringenKey temp = new ie.ucd.srg.koa.koaschema.KieskringenKey();
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	public void privateSetFk_dist_kkrKey(ie.ucd.srg.koa.koaschema.KieskringenKey inKey) {
	...
	public ie.ucd.srg.koa.koaschema.Kieskringen getFk_dist_kkr() throws java.rmi.RemoteException, javax.ejb.FinderException {
		return (ie.ucd.srg.koa.koaschema.Kieskringen)this.getFk_dist_kkrLink().value();
	}
}
