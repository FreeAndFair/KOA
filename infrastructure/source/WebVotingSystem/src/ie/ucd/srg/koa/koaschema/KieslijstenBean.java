...
import ie.ucd.srg.koa.koaschema.KieslijstenToFk_kkr_1Link;
import ie.ucd.srg.koa.koaschema.KieslijstenToLijstpositiesLink;
...
public class KieslijstenBean implements javax.ejb.EntityBean
{
	...
	private transient ie.ucd.srg.ivj.ejb.associations.interfaces.SingleLink fk_kkr_1Link;
	private transient ie.ucd.srg.ivj.ejb.associations.interfaces.ManyLink lijstpositiesLink;
	/**
	 * getEntityContext
	 */
	 ...
	 */
	public ie.ucd.srg.koa.koaschema.KieslijstenKey ejbCreate(
	 ...
	 */
	public void setFk_kkr_1(ie.ucd.srg.koa.koaschema.Kieskringen aFk_kkr_1)
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	protected ie.ucd.srg.ivj.ejb.associations.interfaces.SingleLink getFk_kkr_1Link()	{
	...
	{
		ie.ucd.srg.koa.koaschema.KieskringenKey temp =
			new ie.ucd.srg.koa.koaschema.KieskringenKey();
	...
	{
		return (ie.ucd.srg.koa.koaschema.Kieskringen) this
			.getFk_kkr_1Link()
			.value();
	}
	/**
