/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.reportserver.KOAStatusReportXMLDBReader.java
  *
  * -----------------------------------------------------------------------
  * 
  ...
  * -----------------------------------------------------------------------
  */
package ie.ucd.srg.koa.reportserver;
...
import ie.ucd.srg.koa.reportserver.AbstractKOAReader;
	...
	public KOAStatusReportXMLDBReader(String sCaller)
	{
		...
		try
		{
			...
			String queryStatistics =
				ie.ucd.srg.koa.db.ReportsDB.SELECT_STATISTICS;
			String queryCounters =
				ie.ucd.srg.koa.db.ControllerDB.SELECT_CURRENT_COUNTERS;
