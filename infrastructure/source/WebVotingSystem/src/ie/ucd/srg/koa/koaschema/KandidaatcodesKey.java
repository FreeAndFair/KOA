...
public class KandidaatcodesKey implements java.io.Serializable
{
	...
	{
		if (otherKey instanceof ie.ucd.srg.koa.koaschema.KandidaatcodesKey)
		{
			ie.ucd.srg.koa.koaschema.KandidaatcodesKey o =
				(ie.ucd.srg.koa.koaschema.KandidaatcodesKey) otherKey;
