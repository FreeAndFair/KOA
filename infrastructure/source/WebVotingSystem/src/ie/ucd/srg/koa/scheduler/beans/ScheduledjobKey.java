...
public class ScheduledjobKey implements java.io.Serializable
{
	...
	{
		if (otherKey
			instanceof ie.ucd.srg.koa.scheduler.beans.ScheduledjobKey)
		{
			ie.ucd.srg.koa.scheduler.beans.ScheduledjobKey o =
				(ie.ucd.srg.koa.scheduler.beans.ScheduledjobKey) otherKey;
