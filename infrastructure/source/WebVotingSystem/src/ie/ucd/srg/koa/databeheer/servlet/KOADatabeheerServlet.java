/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.databeheer.servlet.KOAServlet.java
  *
  * -----------------------------------------------------------------------
  * 
  ...
  * -----------------------------------------------------------------------
  */
package ie.ucd.srg.koa.databeheer.servlet;

import java.io.IOException;
import ie.ucd.srg.koa.utils.KOALogHelper;
//import ie.ucd.srg.koa.votecommands.*;
import ie.ucd.srg.koa.databeheer.command.*;
	...
	extends ie.ucd.srg.logica.eplatform.servlet.AbstractBaseServlet
{
	...
	private HttpCommandFactory commandFactory;
	/** 
		...
		throws javax.servlet.ServletException, java.io.IOException
	{
		...
		catch (Exception e)
		{
			...
			if (command == null)
			{
				...
				/* Alan Morkan properties functionality needs to be implemented
				 * redirect(
					request,
					response,
					props.getProperty(
