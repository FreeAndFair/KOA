 ...
 * @generated
 */
public class EJSJDBCPersisterCMPEsbfingerprintsBean extends EJSJDBCPersister implements ie.ucd.srg.koa.esb.beans.EJSFinderEsbfingerprintsBean {
	/**
	 * @generated
	 */
	...
	public void _create(EntityBean eb) throws Exception {
		...
		try {
			...
			objectTemp = ie.ucd.srg.vap.converters.streams.VapBinaryStreamToSerializableObjectConverter.singleton().dataFrom(b.fingerprint);
			if (objectTemp == null) {
	...
	public void hydrate(EntityBean eb, Object data, Object pKey) throws Exception {
		Object objectTemp = null;
		EsbfingerprintsBean b = (EsbfingerprintsBean) eb;
		ie.ucd.srg.koa.esb.beans.EsbfingerprintsKey _primaryKey = (ie.ucd.srg.koa.esb.beans.EsbfingerprintsKey)pKey;
		java.sql.ResultSet resultSet = (java.sql.ResultSet) data;
		b.id = _primaryKey.id;
		b.fingerprint = (byte[])ie.ucd.srg.vap.converters.streams.VapBinaryStreamToSerializableObjectConverter.singleton().objectFrom(resultSet.getBlob(2));
	...
	public void refresh(EntityBean eb, boolean forUpdate) throws Exception {
		EsbfingerprintsBean b = (EsbfingerprintsBean) eb;
		ie.ucd.srg.koa.esb.beans.EsbfingerprintsKey _primaryKey = new ie.ucd.srg.koa.esb.beans.EsbfingerprintsKey();
		_primaryKey.id = b.id;
	...
	public Object getPrimaryKey(Object data) throws Exception {
		ie.ucd.srg.koa.esb.beans.EsbfingerprintsKey key = new ie.ucd.srg.koa.esb.beans.EsbfingerprintsKey();
		java.sql.ResultSet resultSet = (java.sql.ResultSet) data;
	 ...
	 * @generated
	 */
	public ie.ucd.srg.koa.esb.beans.Esbfingerprints findByPrimaryKey(ie.ucd.srg.koa.esb.beans.EsbfingerprintsKey primaryKey) throws java.rmi.RemoteException, javax.ejb.FinderException {
		return (ie.ucd.srg.koa.esb.beans.Esbfingerprints) home.activateBean(primaryKey);
	}
	/**
	...
	public ie.ucd.srg.koa.esb.beans.Esbfingerprints findLatestFingerprint() throws javax.ejb.FinderException, java.rmi.RemoteException {
		...
		ie.ucd.srg.koa.esb.beans.Esbfingerprints result = null;
		...
		try {
			...
			if (tmpFinder.hasMoreElements()) {
				result = (ie.ucd.srg.koa.esb.beans.Esbfingerprints)tmpFinder.nextElement();
			}
		}
		catch (Exception ex) {
