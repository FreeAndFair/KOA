/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.stemproces.beans.StemprocesSessionEJBBean.java
  *
  * -----------------------------------------------------------------------
  * 
...
import ie.ucd.srg.koa.kr.beans.KRSessionEJB;
import ie.ucd.srg.koa.kr.beans.KRSessionEJBHome;
import ie.ucd.srg.koa.kr.beans.Kiezers;
import ie.ucd.srg.koa.kr.beans.KiezersHome;
import ie.ucd.srg.koa.kr.beans.KiezersKey;
import ie.ucd.srg.koa.kr.beans.Transactioncode;
...
public class StemprocesSessionEJBBean implements javax.ejb.SessionBean
{
	 ...
	 */
	//@ requires xStem != null;
	//@ requires xKiezer != null;
	//@ requires xStemTransactie != null;
	//@ ensures \result != null;
	 ...
	 * 
	 * @exception ie.ucd.srg.koa.exception.KOAException is thrown whem something has gone wrong.
	 */
	//@ requires xStem != null;
	//@ requires sStemcode != null;
	//@ requires sWachtwoord != null;
	//@ ensures \result != null;
	//@ signals (KOAException) false;
