...
public class LijstpositiesKey implements java.io.Serializable
{
	...
	public LijstpositiesKey(
		...
		ie.ucd.srg.koa.koaschema.KieslijstenKey argFk_klkr_1)
	{
	...
	{
		if (otherKey instanceof ie.ucd.srg.koa.koaschema.LijstpositiesKey)
		{
			ie.ucd.srg.koa.koaschema.LijstpositiesKey o =
				(ie.ucd.srg.koa.koaschema.LijstpositiesKey) otherKey;
			return (
