 ...
 * @author: KuijerM
 */
public class KOACommandFactory implements ie.ucd.srg.logica.eplatform.command.http.HttpCommandFactory{
	/* the singleton instance of the command factory */
	private static ie.ucd.srg.logica.eplatform.command.http.HttpCommandFactory factory = null;
	...
	private KOACommandFactory() throws ClassNotFoundException{
		...
		commandMapping.put(
			"/Login",
			Class.forName("ie.ucd.srg.koa.voorzitter.command.LoginCommand"));
		commandMapping.put(
			"/GetCurrentState",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.GetCurrentStateCommand"));
		commandMapping.put(
			"/GetCurrentCounters",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.GetCurrentCounterCommand"));
		commandMapping.put(
			"/ChangeStateInitialize",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.statechange.InitializeCommand"));
		commandMapping.put(
			"/ChangeStateReInitialize",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.statechange.ReInitializeCommand"));
		commandMapping.put(
			"/ChangeStateOpen",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.statechange.OpenCommand"));
		commandMapping.put(
			"/ChangeStateClose",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.statechange.CloseCommand"));
		commandMapping.put(
			"/ChangeStateSuspend",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.statechange.SuspendCommand"));
		commandMapping.put(
			"/ChangeStatePrepareVoteCount",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.statechange.PrepareVoteCountCommand"));
		commandMapping.put(
			"/ChangeStateCountVote",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.statechange.CountVoteCommand"));
		commandMapping.put(
			"/ChangeStatePrepare",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.statechange.PrepareCommand"));
		commandMapping.put(
			"/Index",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.IndexPaginaCommand"));
		commandMapping.put(
			"/Report",
			Class.forName(
				"ie.ucd.srg.koa.reportserver.command.KOAReportCommand"));
		commandMapping.put(
			"/CompareFingerprints",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.CompareKieslijstFingerprints"));
		commandMapping.put(
			"/ShowReports",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.ShowReportsCommand"));
		commandMapping.put(
			"/FetchData",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.FetchDataCommand"));
		commandMapping.put(
			"/SelectProcesVerbaal",
			Class.forName(
				"ie.ucd.srg.koa.voorzitter.command.SelectProcesVerbaalCommand"));
		LogHelper.log(
			LogHelper.INFO,
	 ...
	 */
	public HttpCommand getCommand(HttpServletRequest request)throws NoSuchCommandException{
