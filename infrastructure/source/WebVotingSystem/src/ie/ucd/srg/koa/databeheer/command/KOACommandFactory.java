/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.databeheer.command.KOACommandFactory.java
  *
  * -----------------------------------------------------------------------
  * 
	...
	implements ie.ucd.srg.logica.eplatform.command.http.HttpCommandFactory
{
	...
	private static ie.ucd.srg.logica.eplatform.command.http.HttpCommandFactory factory;
	...
	private KOACommandFactory() throws ClassNotFoundException
	{
		...
		commandMapping.put(
			"/Login",
			Class.forName("ie.ucd.srg.koa.databeheer.command.LoginCommand"));
		commandMapping.put(
			"/ScheduledJobsOverview",
			Class.forName(
				"ie.ucd.srg.koa.databeheer.command.ScheduledJobsAdministrationCommand"));
		commandMapping.put(
			"/JobTypesOverview",
			Class.forName(
				"ie.ucd.srg.koa.databeheer.command.JobTypesAdministrationCommand"));
		commandMapping.put(
			"/UploadKieslijst",
			Class.forName("ie.ucd.srg.koa.databeheer.command.Upload"));
		commandMapping.put(
			"/UploadKRRemove",
			Class.forName("ie.ucd.srg.koa.databeheer.command.Upload"));
		commandMapping.put(
		...
		commandMapping.put(
			"/ProcessUpload",
			Class.forName(
				"ie.ucd.srg.koa.databeheer.command.ProcessUpload"));
		commandMapping.put(
			"/SelectExport",
			Class.forName(
				"ie.ucd.srg.koa.databeheer.command.SelectExportCommand"));
		commandMapping.put(
			"/Report",
			Class.forName(
		...
		commandMapping.put(
			"/SelectUpload",
			Class.forName(
				"ie.ucd.srg.koa.databeheer.command.SelectUploadCommand"));
	}
	/**
