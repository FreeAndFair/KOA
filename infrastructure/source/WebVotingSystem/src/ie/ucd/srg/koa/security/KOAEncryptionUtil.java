/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.security.KOAEncryptionUtil.java
  *
  * -----------------------------------------------------------------------
  * 
  ...
  * -----------------------------------------------------------------------
  */
package ie.ucd.srg.koa.security;
...
public class KOAEncryptionUtil
{
	...
	/*
	 * Original GPL Release: CHANGED THE LENGTH FOR PUBLICATION PURPOSES
	 * SRG: Reverse-engineered from Radboud KOA Tally Application
	 */
	private final static int SECRET_KEY_LENGTH = 168;
	/*
	 * Original GPL Release: CHANGED THE SALT FOR PUBLICATION PURPOSES
	 * SRG: Reverse-engineered from Radboud KOA Tally Application
	 */
	...
	/*
	 * Original GPL Release: CHANGED THE ENCRYPTION KEY FOR PUBLICATION PURPOSES
	 * SRG: Reverse-engineered from Radboud KOA Tally Application
	 */
	private final static String encryptionKey = "KOAKey";
	static {
	    /**@author Alan Morkan
	     * The following line is commmented out as this particular encryption utility is proprietary.
	     * The other encryption utility is being used instead as is used in the Telprogramma.
	     */
