...
public class EncryptedesbKey implements java.io.Serializable
{
	...
	{
		if (otherKey instanceof ie.ucd.srg.koa.esb.beans.EncryptedesbKey)
		{
			ie.ucd.srg.koa.esb.beans.EncryptedesbKey o =
				(ie.ucd.srg.koa.esb.beans.EncryptedesbKey) otherKey;
