/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.security.KOAKeyPair.java
  *
  * -----------------------------------------------------------------------
  * 
...
public class KOAKeyPair
{
	...
	public static void main(String[] args)
	{
		java.security.Security.addProvider(
						    ...
						    *The following utility has been replaced as it is proprietary
						    */
		...
		try
		{
			java.io.FileOutputStream fosPub =
				new java.io.FileOutputStream("/home/alanm/eclipse-3.1.1/workspace/samples/KOA_publickoakey.key");
			java.io.FileOutputStream fosPriv =
				new java.io.FileOutputStream("/home/alanm/eclipse-3.1.1/workspace/samples/KOA_privatekoakey.key");
