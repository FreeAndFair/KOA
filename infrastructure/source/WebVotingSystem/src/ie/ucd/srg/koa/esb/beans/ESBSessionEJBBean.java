/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.esb.beans.ESBSessionEJBBean
  *
  * -----------------------------------------------------------------------
  * 
...
import ie.ucd.srg.koa.constants.VoteConstants;
...
import ie.ucd.srg.koa.dataobjects.EncryptedStem;
import ie.ucd.srg.koa.dataobjects.Fingerprint;
import ie.ucd.srg.koa.dataobjects.Kandidaat;
import ie.ucd.srg.koa.db.BLOBResultSet;
...
import ie.ucd.srg.koa.esb.beans.ESBSequencesEJB;
import ie.ucd.srg.koa.esb.beans.ESBSequencesEJBHome;
import ie.ucd.srg.koa.esb.beans.ESBSequencesEJBKey;
import ie.ucd.srg.koa.esb.beans.Encryptedesb;
import ie.ucd.srg.koa.esb.beans.EncryptedesbHome;
import ie.ucd.srg.koa.esb.beans.Esbfingerprints;
import ie.ucd.srg.koa.esb.beans.EsbfingerprintsHome;
import ie.ucd.srg.koa.eventhandling.AuditEventListener;
...
public class ESBSessionEJBBean implements javax.ejb.SessionBean
{
	...
	public void openESB(byte[] baPrivateKey, String sPassword)
		throws ie.ucd.srg.koa.exception.KOAException
	{
		KOALogHelper.log(
			KOALogHelper.TRACE,
	 ...
	 * 
	 */
	public void telStemmen() throws ie.ucd.srg.koa.exception.KOAException
	{
		KOALogHelper.log(
			KOALogHelper.INFO,
	 ...
	 * 
	 */
	private CallResult block() throws ie.ucd.srg.koa.exception.KOAException
	{
		KOALogHelper.log(
			KOALogHelper.WARNING,
	 ...
	 * 
	 * @exception ie.ucd.srg.koa.exception.KOAException
	 */
	 ...
	 * @exception ie.ucd.srg.koa.exception.KOAException
	 */
	private int getVoteCount() throws ie.ucd.srg.koa.exception.KOAException
	{
		KOALogHelper.log(
			KOALogHelper.INFO,
	...
	private Fingerprint createFingerprint()
		throws ie.ucd.srg.koa.exception.KOAException
	{
		ie.ucd.srg.koa.dataobjects.Fingerprint xNewFP =
			new ie.ucd.srg.koa.dataobjects.Fingerprint();
	 ...
	 * @exception ie.ucd.srg.koa.exception.KOAException
	 */
	public void emptyESB() throws ie.ucd.srg.koa.exception.KOAException
	{
		try
		{
			DBUtils xDBUtils =
		...
		catch (ie.ucd.srg.koa.exception.KOADBException xKOADBExc)
		{
	...
	private String getMessage(String code, String[] params)
	{
		 ...
		 *TODO A proper body to the following catch statement should be written
		 */ 
