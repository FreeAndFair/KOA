...
import ie.ucd.srg.koa.security.FingerPrint;
...
public class KOAEncryptionUtil {
  ...
  static {
    // @FIXME find or write a suitable open-source security provider
 ...
 * @throws IOException 
   */
  public static byte[] encrypt(PublicKey xRSAKey, String sData) throws KOAException, ie.ucd.srg.koa.exception.KOAException, NoSuchPaddingException, InvalidKeyException, IllegalStateException, IllegalBlockSizeException, InvalidAlgorithmParameterException, BadPaddingException, IOException{
    try {
 ...
 * @throws IllegalStateException 
   */
  public static String decrypt(PrivateKey xRSAKey, byte[] encryptedBytes) throws KOAException, IOException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalStateException, IllegalBlockSizeException, BadPaddingException {
    try {
   ...
   * worden gebruikt. Voor de vercijferde stemmen is er slechts n kolom van
   * toepassing.
   */
  /**
 ...
 * @throws ie.ucd.srg.koa.exception.KOAException 
   *
   */
  public static byte[] getBLOBFingerPrint(String datasourceName, String schemaName, String tableName, String[] columns, String sortKey) throws sos.koa.KOAException, ie.ucd.srg.koa.exception.KOAException {
