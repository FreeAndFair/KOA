    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
		...
		Candidate candidate12 = new Candidate();
			...
			case(1): return candidate;
			         ...
			         return candidate;
		        case(3): return candidate.isAfter(candidate2);
                        case(4): return candidate.isAfter(candidate3);
                        case(5): return candidate.isAfter(candidate4); 
                        case(6): return candidate.isAfter(candidate5);
                        case(7): return candidate.isAfter(candidate6);
			case(8): return candidate.isAfter(candidate7);  
                        case(9): return candidate.isAfter(candidate8);
			case(10):return candidate.isAfter(candidate9); 
                        case(11):return candidate.isAfter(candidate10);
		        case(12): return candidate.isAfter(candidate11);
                        case(13):return candidate.isAfter(candidate12);
                        // replace this comment with test data if desired
                    default:
                        break;
                    }
