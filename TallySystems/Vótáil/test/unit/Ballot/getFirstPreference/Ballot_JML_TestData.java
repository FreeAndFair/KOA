...
package ie.ucd.srg.Ballot.getFirstPreference;
			...
			case(1):
			    return ballot;
                        case(2):
                             ballot.load(a,1,2);
			    return ballot;
		        case(3): return ballot.getFirstPreference();
                        case(4):
                             ballot.load(b,2,2);
			    return ballot;
                        case(5): return ballot.getFirstPreference();
                        case(6):
			    ballot.load(c,ballot.MAXIMUM_ROUNDS_OF_COUNTING-1,2);
			    return ballot;
                        case(7): return ballot.getFirstPreference();
			case(8):
                             ballot.load(d,ballot.MAXIMUM_ROUNDS_OF_COUNTING,2);
			    return ballot;
                        case(9): return ballot.getFirstPreference();
			case(10):
			     ballot.load(e,2147483646,2);
			    return ballot; 
                        case(11): return ballot.getFirstPreference();
			case(12):
                             ballot.load(f,2147483647,2);
			    return ballot;
                        case(13): return ballot.getFirstPreference();
                    default:
                        break;
                    }
