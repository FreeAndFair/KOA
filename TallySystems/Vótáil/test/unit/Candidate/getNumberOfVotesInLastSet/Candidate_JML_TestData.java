        ...
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
		        ...
		        case(1): return candidate;
			         ...
			         return candidate;
		        case(3): candidate.addVote(10387,1);
			         return candidate;
		        case(4): return candidate.getNumberOfVotesInLastSet();
		        case(5): candidate.addVote(2387,2);
			         return candidate;
		        case(6): return candidate.getNumberOfVotesInLastSet();
		        case(7): candidate.addVote(5635,5);
			         return candidate;
		        case(8): return candidate.getNumberOfVotesInLastSet();
                        case(9): candidate.addVote(932,23);
			         return candidate;
		        case(10): return candidate.getNumberOfVotesInLastSet();
		        case(11): candidate.addVote(0,74);
			         return candidate;
		        case(12): return candidate.getNumberOfVotesInLastSet();
		        case(13): candidate.addVote(1566,candidate.MAXCOUNT-1);
			         return candidate;
		        case(14): return candidate.getNumberOfVotesInLastSet();
                        // replace this comment with test data if desired
                    default:
                        break;
                    }
