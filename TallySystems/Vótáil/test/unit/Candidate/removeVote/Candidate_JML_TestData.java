		...
		Candidate candidate3 = new Candidate();
	        protected Object make(int n) {
		        ...
		        case(3): candidate.addVote(10387,1);
			         return candidate;
		        case(4): candidate.declareElected();
			         return candidate;
		        case(5): candidate.removeVote(2393,1);
			         return candidate;
		        case(6): candidate2.setCandidateID(11);
			         return candidate2;
		        case(7): candidate.addVote(387,4);
			         return candidate2;
		        case(8): candidate2.declareEliminated();
			         return candidate2;
		        case(9): candidate2.removeVote(173,4);
			         return candidate2;
                        case(10): candidate3.setCandidateID(10);
			         return candidate3;
		        case(11): candidate3.addVote(9383,candidate.MAXCOUNT-1);
			         return candidate3;
		        case(12): candidate3.declareElected();
			         return candidate3;
		        case(13): candidate.removeVote(9383,candidate.MAXCOUNT-1);
			         return candidate3;
                        // replace this comment with test data if desired
                    default:
                        break;
