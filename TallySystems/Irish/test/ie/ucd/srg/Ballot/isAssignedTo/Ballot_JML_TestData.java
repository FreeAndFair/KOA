...
package ie.ucd.srg.Ballot.isAssignedTo;
			...
			case(1):
			    return ballot;
                        case(2):
                             ballot.load(a,1,2);
			    return ballot;
		        case(3): return ballot.isAssignedTo(1);
                        case(4):
                             ballot.load(b,2,9);
			    return ballot;
                        case(5): return ballot.isAssignedTo(16);
                        case(6):
			    ballot.load(c,ballot.MAXIMUM_ROUNDS_OF_COUNTING-1,246);
			    return ballot;
                        case(7): return ballot.isAssignedTo(35);
			case(8):
                             ballot.load(d,ballot.MAXIMUM_ROUNDS_OF_COUNTING,217);
			    return ballot;
                        case(9): return ballot.isAssignedTo(5687);
			case(10):
			     ballot.load(e,2147483646,26);
			    return ballot; 
                        case(11): return ballot.isAssignedTo(2147483646);
			case(12):
                             ballot.load(f,2147483647,954);
			    return ballot;
                        case(13): return ballot.isAssignedTo(2147483647);
                    default:
                        break;
                    }
