...
package ie.ucd.srg.Ballot.isAfter;
    ...
    extends junit.framework.TestCase
{
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
		...
		Ballot ballot10 = new Ballot();
		Ballot ballot11 = new Ballot();
		Ballot ballot12 = new Ballot();
		long[] a= new long[1];
                ...
                protected Object make(int n) {
                    switch (n) {
                    // replace this comment with test data if desired
			case(1): return ballot;
                        case(2): ballot.load(a,1,2);
			         return ballot;
		        case(3): return ballot.isAfter(ballot2);
                        case(4): return ballot.isAfter(ballot3);
                        case(5): return ballot.isAfter(ballot4); 
                        case(6): return ballot.isAfter(ballot5);
                        case(7): return ballot.isAfter(ballot6);
			case(8): return ballot.isAfter(ballot7);  
                        case(9): return ballot.isAfter(ballot8);
			case(10):return ballot.isAfter(ballot9); 
                        case(11):return ballot.isAfter(ballot10);
			case(12): return ballot.isAfter(ballot11);
                        case(13):return ballot.isAfter(ballot12);
                    default:
                        break;
                    }
