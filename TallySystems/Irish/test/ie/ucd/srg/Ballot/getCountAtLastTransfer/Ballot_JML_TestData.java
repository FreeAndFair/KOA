// This file was generated by jmlunit on Wed Apr 18 16:30:09 IST 2007.

package ie.ucd.srg.Ballot.getCountAtLastTransfer;
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
		...
		Ballot ballot = new Ballot();
                ...
                protected Object make(int n) {
                    switch (n) {
                    // replace this comment with test data if desired
		    case(0): ballot.load(a,10,5);
			return ballot;
		    case(1): ballot.transfer(1);
                        return ballot;
		    case(2): return ballot.getCountAtLastTransfer();
		    case(3): ballot.transfer(2);
                        return ballot;
		    case(4): return ballot.getCountAtLastTransfer();
		    case(5): ballot.transfer(3);
                        return ballot;
		    case(6): return ballot.getCountAtLastTransfer();
		    case(7): ballot.transfer(4);
                        return ballot;
		    case(8): return ballot.getCountAtLastTransfer();
		    case(9): ballot.transfer(5);
                        return ballot;
		    case(10): return ballot.getCountAtLastTransfer();
                    default:
                        break;
                    }
