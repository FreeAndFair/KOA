        ...
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
		        ...
		        case(3): candidate.addVote(10387,1);
			         return candidate;
		        case(4): candidate.addVote(2387,2);
			         return candidate;
		        case(5): candidate.addVote(5635,5);
			         return candidate;
                        case(6): candidate.addVote(932,23);
			         return candidate;
		        case(7): candidate.addVote(0,74);
			         return candidate;
		        case(8): candidate.addVote(1566,candidate.MAXCOUNT-1);
			         return candidate;
                        // replace this comment with test data if desired
                    default:
                        break;
