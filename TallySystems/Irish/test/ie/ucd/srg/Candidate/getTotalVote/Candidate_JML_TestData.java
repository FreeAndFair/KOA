        ...
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
		        ...
		        case(1):  return candidate;
			          ...
			          return candidate;
		        case(3):  return candidate.getTotalVote();
		        case(4):  candidate.addVote(10387,1);
			          return candidate;
                        case(5):  return candidate.getTotalVote();
		        case(6):  candidate.addVote(2387,2);
			          return candidate;
		        case(7):  return candidate.getTotalVote();
		        case(8):  candidate.addVote(5635,5);
			          return candidate;
		        case(9):  return candidate.getTotalVote();
		        case(10): candidate.addVote(1566,candidate.MAXCOUNT-1);
			          return candidate;
                        case(11): return candidate.getTotalVote();
		        case(12): candidate.declareElected();
			          return candidate; 
                        case(13): candidate.addVote(893,candidate.MAXCOUNT-1);
			          return candidate;
                        case(14): return candidate.getTotalVote(); 
                        // replace this comment with test data if desired
                    default:
                        break;
                    }
