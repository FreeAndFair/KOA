    ...
    extends junit.framework.TestCase
{
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
		...
		Candidate candidate3 = new Candidate();
		        ...
		        case(2):  return candidate.getState();
                        case(3):  candidate.setCandidateID(10);
			          return candidate;
		        case(4):  return candidate.getState();
		        case(5):  candidate2.setCandidateID(11);
			          return candidate2;
		        case(6):  return candidate2.getState();
		    case(7):   candidate2.declareElected();
                        case(8):  return candidate2.getState();
		        case(9):  candidate3.setCandidateID(12);
			          return candidate3;
		        case(10): return candidate3.getState();
		        case(11): candidate3.declareEliminated();
                        case(12): return candidate3.getState();
