...
<%
	ie.ucd.srg..koa.voorzitter.command.ShowReportsCommand xCommand = (ShowReportsCommand) request.getAttribute(CommandConstants.COMMAND_IN_REQUEST_KEY);
...
<TITLE>KOA Remote Voting - Voorzitter - Toon rapporten</TITLE>
      ...
      <table width="725" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr valign="top">
                ...
                <table width="100%" height="100%">
                	<tr><td>On this page the returning officer can query reports.</td></tr>
                	<tr><td>The current system state is: <b><%= sDutchCurrentState %></b></td></tr>
                	<tr><td>Make a choice from the options below:</td></tr>
                	<tr>
                	  <td valign="top">
                		<ul>
                			<li><a href="SelectProcesVerbaal">Opvragen logbestand</A></li>
                			<% 
                				if(xCommand != null && xCommand.getCurrentState().equals(SystemState.VOTES_COUNTED))
                				{
                			%>
                				<li><a href="javascript:open_child('Report?report=uitslag','')">Opvragen resultaat van de stemming</A></li>
                			<%  } %>
                		</ul>
                      </td>
                      </tr>
