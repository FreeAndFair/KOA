...
<%@page import="ie.ucd.srg.koa.reportserver.KOAStatusReportData"%>
<%@page import="java.util.Calendar"%>
<%@page import="java.util.GregorianCalendar"%>


<%
   ie.ucd.srg.koa.voorzitter.command.IndexPaginaCommand xCommand = (IndexPaginaCommand) request.getAttribute(CommandConstants.COMMAND_IN_REQUEST_KEY);
        ...
        <TABLE WIDTH="100%" HEIGHT="100%" BORDER="1" BORDERCOLOR="white">
          <TR>
            <TD VALIGN="top" BORDERCOLOR="blue">
              ...
              %>
                  <BUTTON STYLE="width:100" DISABLED>Modify<BR>status</BUTTON><BR><BR>
              <% } %>
              <BUTTON STYLE="width:100" ONCLICK="window.location='ShowReports'">Reports</BUTTON><BR><BR>
              <BUTTON STYLE="width:100" ONCLICK="window.location='FetchData'">Fetch<BR>Data</BUTTON><BR><BR>
              <% 
                 if(xCommand == null || !xCommand.getCurrentState().equals(SystemState.OPEN))
                 {
              %>
                  <BUTTON STYLE="width:100" ONCLICK="window.location='CompareFingerprints'">Finger<BR>prints</BUTTON>
              <% }
                 else {
              %>
                    ...
                    <TR HEIGHT="50%">
                      <TD VALIGN="bottom">
                        <TABLE WIDTH="100%" HEIGHT="100%" CELLSPACING="0" CELLPADDING="5" BORDER="1" BORDERCOLOR="black" frame="box" rules="none">
                          ...
                          <TR HEIGHT="40">
                            <TD ALIGN="right" nowrap>Number of people:</TD>
                            <TD ALIGN="right" nowrap><%= totaal_kiezers %></TD>
                          </TR>
                          <TR HEIGHT="40">
                            <TD ALIGN="right" nowrap>Of which excluded:</TD>
                            <TD ALIGN="right" nowrap><U><%= uitgesloten_kiezers %></U></TD>
                          </TR>
                          <TR HEIGHT="40">
                            <TD ALIGN="right" nowrap>Of which entitled to vote:</TD>
                  ...
                  <TABLE WIDTH="100%" HEIGHT="100%">
                    ...
                    <TR HEIGHT=40%">
                      <TD ALIGN="right" VALIGN="bottom">
                        <TABLE WIDTH="100%" HEIGHT="100%" CELLSPACING="0" CELLPADDING="5" BORDER="1" BORDERCOLOR="black" frame="box" rules="none">
                          <TR HEIGHT="40">
                            <TH ALIGN="left" COLSPAN="2" nowrap>Poll</TH>
                          </TR>
                          <TR HEIGHT="40">
                            <TD ALIGN="right" nowrap>Not yet voted:</TD>
                            <TD ALIGN="right" nowrap><%= kiezers_nog_niet_gestemd %></TD>
                          </TR>
                          <TR HEIGHT="40">
                            <TD ALIGN="right" nowrap>Already voted:</TD>
                  ...
                  <TABLE WIDTH="100%" HEIGHT="100%">
                    ...
                    <TR HEIGHT=30%">
                      ...
                      <TD ALIGN="center" VALIGN="top">
                        <TABLE WIDTH="100%" HEIGHT="100%" CELLSPACING="0" CELLPADDING="5" BORDER="1" BORDERCOLOR="black" frame="box" rules="none">
                          <TR HEIGHT="40">
                            <TH ALIGN="left" COLSPAN="2" nowrap>Method of Voting</TH>
                          </TR>
                          <TR HEIGHT="40">
                          ...
                          <TR HEIGHT="40">
                            <TD ALIGN="right" nowrap>Via telephone:</TD>
              ...
              <TR>
                ...
                <TD ALIGN="right" WIDTH="66%">
                  <TABLE WIDTH="100%" HEIGHT="100%" CELLSPACING="0" CELLPADDING="5" BORDER="1" BORDERCOLOR="black" FRAMES="box" RULES="none">
                    ...
                    <TR>
                      <TD ALIGN="left">Number of temporarily blocked vote codes:</TD>
