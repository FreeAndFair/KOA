/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.databeheer.ejb.session.KiesRegisterAdminBean.java
  *
  * -----------------------------------------------------------------------
  * 
...
import ie.ucd.srg.logica.eplatform.util.XMLProperties;
...
import ie.ucd.srg.koa.databeheer.ejb.session.KiesRegisterAdminHelper;
import ie.ucd.srg.koa.databeheer.ejb.session.KiesRegisterAdminHelperHome;
import ie.ucd.srg.koa.databeheer.xml.KiesRegisterExportWriter;
import ie.ucd.srg.koa.databeheer.xml.WrongIdWriter;
import ie.ucd.srg.koa.dataobjects.Fingerprint;
import ie.ucd.srg.koa.db.DBUtils;
import ie.ucd.srg.koa.db.DataBeheerDB;
import ie.ucd.srg.koa.db.ReportsDB;
import ie.ucd.srg.koa.db.TransactionCodeDB;
...
public class KiesRegisterAdminBean implements javax.ejb.SessionBean
{
	...
	{
		ie.ucd.srg.koa.dataobjects.Fingerprint xFingerprint =
