...
public interface KRFingerprintsHome extends javax.ejb.EJBHome
{
	 ...
	 */
	public ie.ucd.srg.koa.kr.beans.KRFingerprints create()
	 ...
	 */
	public ie.ucd.srg.koa.kr.beans.KRFingerprints findByPrimaryKey(
		ie.ucd.srg.koa.kr.beans.KRFingerprintsKey primaryKey)
		throws javax.ejb.FinderException, java.rmi.RemoteException;
	/**
	 * Finds an instance using a key for Entity Bean: KRFingerprints
	 */
	public ie.ucd.srg.koa.kr.beans.KRFingerprints findLatestFingerprint(
		java.lang.Integer type)
		throws javax.ejb.FinderException, java.rmi.RemoteException;
	/**
	 * Finds an instance using a key for Entity Bean: KRFingerprints
	 */
	public ie.ucd.srg.koa.kr.beans.KRFingerprints findByTypeAndState(
		java.lang.Integer type,
	 ...
	 * Finds an instance using a key for Entity Bean: KRFingerprints
	 */
	public ie.ucd.srg.koa.kr.beans.KRFingerprints findLastFP()
		throws javax.ejb.FinderException, java.rmi.RemoteException;
	/**
	 * Finds the last created Dynamic Fingerprint instance in the blocked or the suspended state
	 */
	public ie.ucd.srg.koa.kr.beans.KRFingerprints findLastDynamicFP(
		java.lang.Integer type,
