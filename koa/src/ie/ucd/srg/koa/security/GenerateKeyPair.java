/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.security.GenerateKeyPair.java
  *
  * -----------------------------------------------------------------------
  * 
...
public class GenerateKeyPair
{
	...
	/**
	 * Length of the public/private keypair (in bytes).
	 * -1 is the default value, the actual value is read from a property file using
	 * {@link ie.ucd.srg.koa.constants.TechnicalProperties#getIntProperty(int)}. 
	 */
