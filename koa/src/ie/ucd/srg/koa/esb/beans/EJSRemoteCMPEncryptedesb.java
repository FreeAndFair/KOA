...
public class EJSRemoteCMPEncryptedesb extends EJSWrapper implements Encryptedesb {
	...
	public byte[] getStem() throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.esb.beans.EncryptedesbBean beanRef = (ie.ucd.srg.koa.esb.beans.EncryptedesbBean)container.preInvoke(this, 0, _EJS_s);
	...
	public void setStem(byte[] newStem) throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.esb.beans.EncryptedesbBean beanRef = (ie.ucd.srg.koa.esb.beans.EncryptedesbBean)container.preInvoke(this, 1, _EJS_s);
