...
public class ESBSequencesEJBKey implements java.io.Serializable
{
	...
	{
		if (otherKey instanceof ie.ucd.srg.koa.esb.beans.ESBSequencesEJBKey)
		{
			ie.ucd.srg.koa.esb.beans.ESBSequencesEJBKey o =
				(ie.ucd.srg.koa.esb.beans.ESBSequencesEJBKey) otherKey;
