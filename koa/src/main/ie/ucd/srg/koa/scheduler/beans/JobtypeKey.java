...
public class JobtypeKey implements java.io.Serializable
{
	...
	{
		if (otherKey instanceof ie.ucd.srg.koa.scheduler.beans.JobtypeKey)
		{
			ie.ucd.srg.koa.scheduler.beans.JobtypeKey o =
				(ie.ucd.srg.koa.scheduler.beans.JobtypeKey) otherKey;
