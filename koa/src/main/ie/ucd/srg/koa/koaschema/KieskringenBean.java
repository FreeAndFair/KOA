...
import ie.ucd.srg.koa.koaschema.KieskringenToDistrictenLink;
import ie.ucd.srg.koa.koaschema.KieskringenToKieslijstenLink;
...
public class KieskringenBean implements javax.ejb.EntityBean
{
	...
	private transient ie.ucd.srg.ivj.ejb.associations.interfaces.ManyLink districtenLink;
	private transient ie.ucd.srg.ivj.ejb.associations.interfaces.ManyLink kieslijstenLink;
	/**
	 * getEntityContext
	 */
	 ...
	 */
	public ie.ucd.srg.koa.koaschema.KieskringenKey ejbCreate(
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	protected ie.ucd.srg.ivj.ejb.associations.interfaces.ManyLink getDistrictenLink()
	{
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	protected ie.ucd.srg.ivj.ejb.associations.interfaces.ManyLink getKieslijstenLink()	{
