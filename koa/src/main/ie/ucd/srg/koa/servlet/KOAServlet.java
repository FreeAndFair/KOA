...
import ie.ucd.srg.logica.eplatform.util.*;
import ie.ucd.srg.koa.votecommands.*;
import ie.ucd.srg.koa.constants.*;
import ie.ucd.srg.koa.exception.*;
import ie.ucd.srg.koa.utils.*;
...
import ie.ucd.srg.koa.controller.client.*;
	...
	extends ie.ucd.srg.logica.eplatform.servlet.AbstractBaseServlet
{
	...
	private ie.ucd.srg.logica.eplatform.command.http.HttpCommandFactory commandFactory;
	/** 
		...
		throws IOException, ServletException
	{
		...
		if (tTemp != null && tTemp.isExpired())
		{
			...
			/**@author Alan Morkan
			 *TODO Complete properly the body of the following catch block
			 */
