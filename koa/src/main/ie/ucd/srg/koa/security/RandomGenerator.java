/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.security.RandomGenerator.java
  *
  * -----------------------------------------------------------------------
  * 
...
public class RandomGenerator
{
	...
	/*
	 * Original GPL Release: CHANGED THE SALT_LENGTE FOR PUBLICATION PURPOSES
	 * SRG: Reverse-engineered from Radboud KOA Tally Application
	 */
	public static final int SALT_LENGTE = 168;
