 ...
 * @generated
 */
public class EJSJDBCPersisterCMPKiezersBean extends EJSJDBCPersister implements ie.ucd.srg.koa.kr.beans.EJSFinderKiezersBean {
	/**
	 * @generated
	 */
	...
	public void _create(EntityBean eb) throws Exception {
		...
		try {
			...
			objectTemp = ie.ucd.srg.vap.converters.VapCharToBoolean.singleton().dataFrom(b.reedsgestemd);
			if (objectTemp == null) {
			...
			objectTemp = ie.ucd.srg.vap.converters.VapCharToBoolean.singleton().dataFrom(b.accountlocked);
			if (objectTemp == null) {
			...
			objectTemp = ie.ucd.srg.vap.converters.VapCharToBoolean.singleton().dataFrom(b.verwijderd);
			if (objectTemp == null) {
	...
	public void hydrate(EntityBean eb, Object data, Object pKey) throws Exception {
		Object objectTemp = null;
		KiezersBean b = (KiezersBean) eb;
		ie.ucd.srg.koa.kr.beans.KiezersKey _primaryKey = (ie.ucd.srg.koa.kr.beans.KiezersKey)pKey;
		...
		b.reedsgestemd = (java.lang.Boolean)ie.ucd.srg.vap.converters.VapCharToBoolean.singleton().objectFrom(resultSet.getString(6));
		...
		b.accountlocked = (java.lang.Boolean)ie.ucd.srg.vap.converters.VapCharToBoolean.singleton().objectFrom(resultSet.getString(14));
		b.timestampunlock = resultSet.getTimestamp(15);
		b.verwijderd = (java.lang.Boolean)ie.ucd.srg.vap.converters.VapCharToBoolean.singleton().objectFrom(resultSet.getString(16));
	}
	/**
	 * load
	 * @generated
	...
	public void refresh(EntityBean eb, boolean forUpdate) throws Exception {
		KiezersBean b = (KiezersBean) eb;
		ie.ucd.srg.koa.kr.beans.KiezersKey _primaryKey = new ie.ucd.srg.koa.kr.beans.KiezersKey();
	...
	public Object getPrimaryKey(Object data) throws Exception {
		ie.ucd.srg.koa.kr.beans.KiezersKey key = new ie.ucd.srg.koa.kr.beans.KiezersKey();
		java.sql.ResultSet resultSet = (java.sql.ResultSet) data;
	 ...
	 * @generated
	 */
	public ie.ucd.srg.koa.kr.beans.Kiezers findByPrimaryKey(ie.ucd.srg.koa.kr.beans.KiezersKey primaryKey) throws java.rmi.RemoteException, javax.ejb.FinderException {
		return (ie.ucd.srg.koa.kr.beans.Kiezers) home.activateBean(primaryKey);
	}
	/**
	 * findByKiezerId
	 * @generated
	...
	public ie.ucd.srg.koa.kr.beans.Kiezers findByKiezerId(java.lang.String sKiezerId) throws javax.ejb.FinderException, java.rmi.RemoteException {
		...
		ie.ucd.srg.koa.kr.beans.Kiezers result = null;
		...
		try {
			...
			if (tmpFinder.hasMoreElements()) {
				result = (ie.ucd.srg.koa.kr.beans.Kiezers)tmpFinder.nextElement();
			}
		}
		catch (Exception ex) {
