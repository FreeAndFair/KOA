 ...
 * @generated
 */
public class EJSJDBCPersisterCMPKRFingerprintsBean extends EJSJDBCPersister implements ie.ucd.srg.koa.kr.beans.EJSFinderKRFingerprintsBean {
	/**
	 * @generated
	 */
	...
	public void hydrate(EntityBean eb, Object data, Object pKey) throws Exception {
		Object objectTemp = null;
		KRFingerprintsBean b = (KRFingerprintsBean) eb;
		ie.ucd.srg.koa.kr.beans.KRFingerprintsKey _primaryKey = (ie.ucd.srg.koa.kr.beans.KRFingerprintsKey)pKey;
		java.sql.ResultSet resultSet = (java.sql.ResultSet) data;
		short shortTemp;
		b.id = _primaryKey.id;
		shortTemp = resultSet.getShort(2);
		b.type = resultSet.wasNull() ? null : new Short(shortTemp);
		b.fingerprint = (byte[])ie.ucd.srg.vap.converters.streams.VapBinaryStreamToSerializableObjectConverter.singleton().objectFrom(resultSet.getBlob(3));
	...
	public void refresh(EntityBean eb, boolean forUpdate) throws Exception {
		KRFingerprintsBean b = (KRFingerprintsBean) eb;
		ie.ucd.srg.koa.kr.beans.KRFingerprintsKey _primaryKey = new ie.ucd.srg.koa.kr.beans.KRFingerprintsKey();
		_primaryKey.id = b.id;
	...
	public Object getPrimaryKey(Object data) throws Exception {
		ie.ucd.srg.koa.kr.beans.KRFingerprintsKey key = new ie.ucd.srg.koa.kr.beans.KRFingerprintsKey();
		java.sql.ResultSet resultSet = (java.sql.ResultSet) data;
	...
	public ie.ucd.srg.koa.kr.beans.KRFingerprints findLatestFingerprint(java.lang.Integer type) throws javax.ejb.FinderException, java.rmi.RemoteException {
		...
		ie.ucd.srg.koa.kr.beans.KRFingerprints result = null;
		...
		try {
			...
			if (tmpFinder.hasMoreElements()) {
				result = (ie.ucd.srg.koa.kr.beans.KRFingerprints)tmpFinder.nextElement();
			}
		}
		catch (Exception ex) {
	 ...
	 * @generated
	 */
	public ie.ucd.srg.koa.kr.beans.KRFingerprints findByPrimaryKey(ie.ucd.srg.koa.kr.beans.KRFingerprintsKey primaryKey) throws java.rmi.RemoteException, javax.ejb.FinderException {
		return (ie.ucd.srg.koa.kr.beans.KRFingerprints) home.activateBean(primaryKey);
	}
	/**
	 * findByTypeAndState
	 * @generated
