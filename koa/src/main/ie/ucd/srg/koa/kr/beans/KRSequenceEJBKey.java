...
public class KRSequenceEJBKey implements java.io.Serializable
{
	...
	{
		if (otherKey instanceof ie.ucd.srg.koa.kr.beans.KRSequenceEJBKey)
		{
			ie.ucd.srg.koa.kr.beans.KRSequenceEJBKey o =
				(ie.ucd.srg.koa.kr.beans.KRSequenceEJBKey) otherKey;
