...
public class EJSRemoteCMPKoa_state extends EJSWrapper implements Koa_state {
	...
	public java.lang.String getCurrent_state() throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.controller.beans.Koa_stateBean beanRef = (ie.ucd.srg.koa.controller.beans.Koa_stateBean)container.preInvoke(this, 0, _EJS_s);
	...
	public void setCurrent_state(java.lang.String newCurrent_state) throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.controller.beans.Koa_stateBean beanRef = (ie.ucd.srg.koa.controller.beans.Koa_stateBean)container.preInvoke(this, 1, _EJS_s);
