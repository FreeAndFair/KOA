...
public class DecryptedesbKey implements java.io.Serializable
{
	...
	{
		if (otherKey instanceof ie.ucd.srg.koa.esb.beans.DecryptedesbKey)
		{
			ie.ucd.srg.koa.esb.beans.DecryptedesbKey o =
				(ie.ucd.srg.koa.esb.beans.DecryptedesbKey) otherKey;
