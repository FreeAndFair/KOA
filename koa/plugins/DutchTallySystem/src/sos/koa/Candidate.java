  ...
  implements Comparable, java.io.Serializable
{
  ...
  //@ invariant my_lastname != my_kiesKring.my_name;
  //@ invariant my_firstname != my_kiesKring.my_name;
  //@ invariant my_initials != my_kiesKring.my_name;
  //@ invariant my_city_of_residence != my_kiesKring.my_name;
  ...
  //@ invariant my_lastname != my_kiesLijst.my_name;
  //@ invariant my_firstname != my_kiesLijst.my_name;
  //@ invariant my_initials != my_kiesLijst.my_name;
  //@ invariant my_city_of_residence != my_kiesLijst.my_name;
   ...
   *   requires a_lastname != a_kieskring.my_name;
   *   requires a_firstname != a_kieskring.my_name;
   *   requires some_initials != a_kieskring.my_name;
   *   requires a_city_of_residence != a_kieskring.my_name;
   *   requires a_lastname != a_kieslijst.my_name;
