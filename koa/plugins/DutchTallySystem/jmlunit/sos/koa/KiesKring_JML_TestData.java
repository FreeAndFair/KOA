// This file was generated by jmlunit on Fri Apr 02 17:12:53 CEST 2004.

package sos.koa;

/**
 * Supply test data for the JML and JUnit based testing of KiesKring.
 *
 ...
 */
public abstract class KiesKring_JML_TestData
  extends junit.framework.TestCase
{
  /** Initialize this class. */
  public KiesKring_JML_TestData(java.lang.String name) {
    super(name);
  }
  ...
  public junit.framework.TestSuite overallTestSuite() {
    return new junit.framework.TestSuite("Overall tests for KiesKring");
  }
   ...
   * test data of type byte for testing the method named by the String
  ...
  /**
   * Return a new, freshly allocated indefinite iterator that produces
   * test data of type sos.koa.District for testing the method named
  ...
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
    vsos_koa_DistrictIter
    (java.lang.String methodName, int loopsThisSurrounds)
  {
    return vsos_koa_DistrictStrategy.iterator();
  }

  /**
   * The strategy for generating test data of type sos.koa.District.
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType
    vsos_koa_DistrictStrategy
    = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
      {
        protected Object make(int n) {
          switch (n) {
          case 0:
            return Global_TestData.getDistrict();
          }
  ...
  /**
   * Return a new, freshly allocated indefinite iterator that produces
   * test data of type java.lang.Object for testing the method named
   * by the String methodName in a loop that encloses
   * loopsThisSurrounds many other loops.
   * @param methodName name of the method for which this test data
   * will be used.
