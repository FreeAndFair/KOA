 ...
 * @generated
 */
public class EJSJDBCPersisterCMPLijstpositiesBean extends EJSJDBCPersister implements ie.ucd.srg.koa.koaschema.EJSFinderLijstpositiesBean {
	/**
	 * @generated
	 */
	...
	public void _create(EntityBean eb) throws Exception {
		...
		try {
			...
			objectTemp = ie.ucd.srg.vap.converters.VapStringToCharacterConverter.singleton().dataFrom(new Character(b.geslacht));
			if (objectTemp == null) {
	...
	public void hydrate(EntityBean eb, Object data, Object pKey) throws Exception {
		Object objectTemp = null;
		LijstpositiesBean b = (LijstpositiesBean) eb;
		ie.ucd.srg.koa.koaschema.LijstpositiesKey _primaryKey = (ie.ucd.srg.koa.koaschema.LijstpositiesKey)pKey;
		...
		objectTemp = ie.ucd.srg.vap.converters.VapStringToCharacterConverter.singleton().objectFrom(resultSet.getString(5));
	...
	public void refresh(EntityBean eb, boolean forUpdate) throws Exception {
		LijstpositiesBean b = (LijstpositiesBean) eb;
		ie.ucd.srg.koa.koaschema.LijstpositiesKey _primaryKey = new ie.ucd.srg.koa.koaschema.LijstpositiesKey();
	...
	public Object getPrimaryKey(Object data) throws Exception {
		ie.ucd.srg.koa.koaschema.LijstpositiesKey key = new ie.ucd.srg.koa.koaschema.LijstpositiesKey();
		java.sql.ResultSet resultSet = (java.sql.ResultSet) data;
	 ...
	 * @generated
	 */
	public ie.ucd.srg.koa.koaschema.Lijstposities findByPrimaryKey(ie.ucd.srg.koa.koaschema.LijstpositiesKey primaryKey) throws java.rmi.RemoteException, javax.ejb.FinderException {
		return (ie.ucd.srg.koa.koaschema.Lijstposities) home.activateBean(primaryKey);
	}
	/**
	 * findLijstpositiesByFk_klkr_1
	 * @generated
	 */
	public EJSFinder findLijstpositiesByFk_klkr_1(ie.ucd.srg.koa.koaschema.KieslijstenKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
