/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.kieslijst.beans.KiesLijstBean.java
  *
  * -----------------------------------------------------------------------
  * 
...
public class KiesLijstBean implements javax.ejb.SessionBean
{
	 ...
	 * 
	 */
	public KiesLijstFingerprintCompareResult compareKieslijstFingerprint()throws KOAException{
		KOALogHelper.log(
			KOALogHelper.INFO,
