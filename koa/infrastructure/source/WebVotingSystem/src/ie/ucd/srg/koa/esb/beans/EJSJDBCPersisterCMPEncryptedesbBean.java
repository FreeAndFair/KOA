 ...
 * @generated
 */
public class EJSJDBCPersisterCMPEncryptedesbBean extends EJSJDBCPersister implements ie.ucd.srg.koa.esb.beans.EJSFinderEncryptedesbBean {
	/**
	 * @generated
	 */
	...
	public void _create(EntityBean eb) throws Exception {
		...
		try {
			...
			objectTemp = ie.ucd.srg.vap.converters.streams.VapBinaryStreamToByteArrayConverter.singleton().dataFrom(b.stem);
			if (objectTemp == null) {
	...
	public void hydrate(EntityBean eb, Object data, Object pKey) throws Exception {
		Object objectTemp = null;
		EncryptedesbBean b = (EncryptedesbBean) eb;
		ie.ucd.srg.koa.esb.beans.EncryptedesbKey _primaryKey = (ie.ucd.srg.koa.esb.beans.EncryptedesbKey)pKey;
		java.sql.ResultSet resultSet = (java.sql.ResultSet) data;
		b.stemnummer = _primaryKey.stemnummer;
		b.stem = (byte[])ie.ucd.srg.vap.converters.streams.VapBinaryStreamToByteArrayConverter.singleton().objectFrom(resultSet.getBlob(2));
	}
	/**
	 * load
	 * @generated
	...
	public void refresh(EntityBean eb, boolean forUpdate) throws Exception {
		EncryptedesbBean b = (EncryptedesbBean) eb;
		ie.ucd.srg.koa.esb.beans.EncryptedesbKey _primaryKey = new ie.ucd.srg.koa.esb.beans.EncryptedesbKey();
	...
	public Object getPrimaryKey(Object data) throws Exception {
		ie.ucd.srg.koa.esb.beans.EncryptedesbKey key = new ie.ucd.srg.koa.esb.beans.EncryptedesbKey();
		java.sql.ResultSet resultSet = (java.sql.ResultSet) data;
	 ...
	 * @generated
	 */
	public ie.ucd.srg.koa.esb.beans.Encryptedesb findByPrimaryKey(ie.ucd.srg.koa.esb.beans.EncryptedesbKey primaryKey) throws java.rmi.RemoteException, javax.ejb.FinderException {
		return (ie.ucd.srg.koa.esb.beans.Encryptedesb) home.activateBean(primaryKey);
	}
}
