...
public class EJSRemoteCMPESBSequencesEJB extends EJSWrapper implements ESBSequencesEJB {
	...
	public java.math.BigDecimal getNextID() throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.esb.beans.ESBSequencesEJBBean beanRef = (ie.ucd.srg.koa.esb.beans.ESBSequencesEJBBean)container.preInvoke(this, 0, _EJS_s);
	...
	public void setNextID(java.math.BigDecimal newNextID) throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.esb.beans.ESBSequencesEJBBean beanRef = (ie.ucd.srg.koa.esb.beans.ESBSequencesEJBBean)container.preInvoke(this, 1, _EJS_s);
