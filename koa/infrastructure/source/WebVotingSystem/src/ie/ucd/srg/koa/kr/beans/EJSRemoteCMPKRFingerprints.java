...
public class EJSRemoteCMPKRFingerprints extends EJSWrapper implements KRFingerprints {
	...
	public byte[] getFingerprint() throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.kr.beans.KRFingerprintsBean beanRef = (ie.ucd.srg.koa.kr.beans.KRFingerprintsBean)container.preInvoke(this, 0, _EJS_s);
	...
	public java.lang.String getSystemstatus() throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.kr.beans.KRFingerprintsBean beanRef = (ie.ucd.srg.koa.kr.beans.KRFingerprintsBean)container.preInvoke(this, 1, _EJS_s);
	...
	public java.sql.Timestamp getTimestamp() throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.kr.beans.KRFingerprintsBean beanRef = (ie.ucd.srg.koa.kr.beans.KRFingerprintsBean)container.preInvoke(this, 2, _EJS_s);
	...
	public void setFingerprint(byte[] newFingerprint) throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.kr.beans.KRFingerprintsBean beanRef = (ie.ucd.srg.koa.kr.beans.KRFingerprintsBean)container.preInvoke(this, 3, _EJS_s);
	...
	public void setSystemstatus(java.lang.String newSystemstatus) throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.kr.beans.KRFingerprintsBean beanRef = (ie.ucd.srg.koa.kr.beans.KRFingerprintsBean)container.preInvoke(this, 4, _EJS_s);
	...
	public void setTimestamp(java.sql.Timestamp newTimestamp) throws java.rmi.RemoteException {
		...
		try {
			ie.ucd.srg.koa.kr.beans.KRFingerprintsBean beanRef = (ie.ucd.srg.koa.kr.beans.KRFingerprintsBean)container.preInvoke(this, 5, _EJS_s);
