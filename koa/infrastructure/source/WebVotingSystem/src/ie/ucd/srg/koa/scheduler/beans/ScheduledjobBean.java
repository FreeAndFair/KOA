...
import ie.ucd.srg.koa.scheduler.beans.ScheduledjobToJobtypeLink;
/**
...
public class ScheduledjobBean implements javax.ejb.EntityBean
{
	...
	private transient ie.ucd.srg.ivj.ejb.associations.interfaces.SingleLink jobtypeLink;
	/**
	 * getEntityContext
	 */
	 ...
	 */
	public ie.ucd.srg.koa.scheduler.beans.ScheduledjobKey ejbCreate(
	 ...
	 */
	public void setJobtype(ie.ucd.srg.koa.scheduler.beans.Jobtype aJobtype)
	...
	public void secondarySetJobtype(
		ie.ucd.srg.koa.scheduler.beans.Jobtype aJobtype)
		throws java.rmi.RemoteException
	{
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	protected ie.ucd.srg.ivj.ejb.associations.interfaces.SingleLink getJobtypeLink()	{
		if (jobtypeLink == null)
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	public ie.ucd.srg.koa.scheduler.beans.JobtypeKey getJobtypeKey()
	{
		ie.ucd.srg.koa.scheduler.beans.JobtypeKey temp =
			new ie.ucd.srg.koa.scheduler.beans.JobtypeKey();
	 ...
	 * It will be deleted/edited when the association is deleted/edited.
	 */
	public ie.ucd.srg.koa.scheduler.beans.Jobtype getJobtype()
		throws java.rmi.RemoteException, javax.ejb.FinderException
	{
		return (ie.ucd.srg.koa.scheduler.beans.Jobtype) this
			.getJobtypeLink()
			.value();
	}
}
