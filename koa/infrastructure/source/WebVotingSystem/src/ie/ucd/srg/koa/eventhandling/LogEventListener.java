/** -----------------------------------------------------------------------
  *
  *   ie.ucd.srg.koa.eventhandling.LogEventListener.java
  *
  * -----------------------------------------------------------------------
  * 
...
import ie.ucd.srg.logica.eplatform.services.logging.LogService;
...
public class LogEventListener implements EventListener
{
	...
	public void init(EventListenerContext elc)
	{
		...
		bIsDebugMode = ie.ucd.srg.koa.constants.TechnicalProps.isDebugMode();
	}
	/**
